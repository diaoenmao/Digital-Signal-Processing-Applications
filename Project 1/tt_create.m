...
digits = input(['Enter touch tone digit sequence in form [n1 n2 n3 ... nN]\n', ...
...
SNRdB = input('Enter SNR (dB): '); % this is the input spec

SNR = 10^(-SNRdB/10);
std_dev=sqrt(SNR);
signal = signal + std_dev*randn(size(signal));
